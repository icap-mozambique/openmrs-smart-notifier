   select coorte12meses_final.patient_id, identifier.identifier, coorte12meses_final.data_inicio, contact.value, coorte12meses_final.data_usar                                                                               
            ...
            (select inicio.*,                                                                                                                    
             ...
             (
                ...
                WHERE last_viral_load_value IS NOT NULL AND last_viral_load_value > 1000 AND DATEDIFF( :endDate , last_viral_load_date) = 1  
			 ...
			 AND pregnant_and_breastfeeding.patient_id IS NULL